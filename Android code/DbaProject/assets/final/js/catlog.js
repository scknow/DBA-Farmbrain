...
function get_sub_cat_get()
{
	...
	{		
		...
		for(i=0;i<jsn.length;i++)
		{
			...
			cat_str=cat_str+'<li onclick="li_cat('+cat_id+',-1)"><div class="category_dba_left_img"><img src="images/1.jpg" /></div><i>All</i></li></ul>';		
					
		}
		cat_str=cat_str+'<li onclick=li_cat("",-1)><big>All</big><div class="category_dba_left"></div></li>';
