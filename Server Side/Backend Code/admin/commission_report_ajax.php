...
include "menu.php";	
							...
							{
								$query=mysql_query("select SUM(totalfinalordered),businessname,customergroupname,totalcmsn,agentcmsn,seccmsn,repcmsn,othercmsn,netcmsn from customer,`order`,customergroup where `order`.customerid=customer.customerid and `order`.customerid='$customer_id' customer.customergroupid=customergroup.customergroupid group by `order`.customerid");
							}
