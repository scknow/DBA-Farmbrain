				...
				<div class="box-content">
					<table class="table table-striped table-bordered bootstrap-datatable datatable">
						...
						<tbody>
							...
							$sql="SELECT * FROM productsubcategory ORDER BY productsubcategoryid DESC";
							//echo $sql;
							$result = mysql_query($sql);
							while ($row = mysql_fetch_array($result))
							{
								...
								echo "<td class='check_box1'><input type='checkbox' class='check_box' onclick=checked_entries('".$row['productsubcategoryid']."')  name='check[]' value='".$row['productsubcategoryid']."'></td>";
	...
	<div class="modal-body">
		...
		<fieldset>	
				<div class="control-group">
					...
					<div class="controls">
						<select name="productcategoryid" id="productcategoryid" required>
					<?
					include "connection.php";
					$sql = "SELECT * FROM productcategory";
		...
		function delete_item(id)
				...
				function product_edit(id){
					...
					.done(function( msg ) {
						...
						if(obj['productsubcategorypic']!='' || obj['productcategorypic']!='a')
						{
							$("#blah").show();
