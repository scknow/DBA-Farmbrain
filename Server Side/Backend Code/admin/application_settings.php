...
?>
			...
			<div class="row-fluid sortable" style='width:72%;margin: 0 auto;'>		
				...
				<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>Change Logo</h2>
				</div>
					<div class="box-content">					
						<center>
							<img src='<?php echo $check['logo'];?>' style='height: 90px;margin-top: 50px;'>				
							<a href='product_field_master.php' class='btn btn-info btn-setting' style='display:block;width: 126px;margin-top:41px;'><i class="icon-edit icon-white"></i>Change Logo</a>
						</center>
					</div>
				</div>	
				
				<div class="box span12" id='change_skin' style='width:100%;min-height:219px;overflow:hidden;float:left;margin: 0;'>				
				<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>Change Skin</h2>
				</div>
					<div class="box-content">					
						
						<div class="btn-group theme-container" style='margin: 18px 0px 14px 0px;'>
						<center>
