...
<html>    <head>        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />        <title>DBA Farmbrain</title>     <style>	 *{margin:0px;}     *{padding:0px;}     body {margin: 0; padding: 0; min-width: 100%!important; font-family:calibri;font-size:14px;}     </style>		    </head>    <body>    <table style="width: 100%; float: left; background:#f3f3f3; box-shadow: 0 1px 2px rgb(160, 160, 160);">    	<tr>        	<td><img src="images/fb.png" style="padding: 12px6px; float: left; width: 80px;"/>            <h1 style="width: auto; float: left; padding-top: 31px; font-size: 30px; color:#707070;">DBA</h1>            </td>        </tr>    </table>               <table style="width: 48%; float: left;">		  <tr>			  <td>			                  <h3 style="font-size: 21px; padding: 20px 12px; color: #a1b226; text-shadow: 0 1px 2px rgb(233, 233, 233);">Welcome to Dutch Bakers Associated!</h3>			  </td>		  </tr>                    <tr>           <td>          	<big style="font-size: 15px; padding: 0 10px 0; display: block; font-weight: 600;">'.$name.'</big>            <p style="padding: 10px;">You&#39;ve just become part of a ground-breaking new approach to expanding your business. You will enjoy greater opportunity to reach farm markets in new and more meaningful ways - not to mention better reporting, real-time order and delivery data, and improved efficiencies in your customer relationships.<br /><br /> The opportunities are huge and we’re glad to see you’ve got the vision for a smarter, better way of doing business. Thanks for joining!</p>	</td>          </tr>			 
        ...
        <table style="width: 100%; float: left; margin: 20px 0 10px;"><tr><td style="text-align: center; font-size: 12px; font-weight: 700; color: rgb(33, 32, 32);">Legal / technical / contact info required?</td></tr>
              ...
              <td style="padding: 10px; color: white; font-size: 11px;">The email address linked to your DBA account is <namename123@internets.com>. <u>Update your email preferences</u> or <u>unsubscribe</u>. Note that even if you unsubscribe, we will send certain account-related emails, such as purchase details or requests for password resets. Have questions? We&#39;re here to help! <u>Contact us anytime</u>.  [Company name and physical address]</td>
            </tr></table></body></html>';
