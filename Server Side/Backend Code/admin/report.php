						...
						<tbody id='data'>
							...
							while($row_productId=mysql_fetch_array($querys))
							{
								...
								if(mysql_num_rows($query)!=0 || mysql_num_rows($query1)!=0)
								{
									...
									if(mysql_num_rows($query)!=0)
									{	
										echo "<td>".$current_qty=format_change($row1['QTY'])."</td>";
										echo "<td>".$current_price=format_change($row1['price'])."</td>";
										echo "<td>".$current_avg_price=format_change($row1['AVG_PRICE'])."</td>";
									}
									else									
									{
										$current_qty=0;
										...
										echo "<td>".format_change($prev_qty)."</td>";
										echo "<td>".format_change($prev_price)."</td>";
										echo "<td>".format_change($prev_avg_price)."</td>";

									}
									if(mysql_num_rows($query)!=0)
									{
										echo "<td>".$prev_qty=format_change($row['QTY'])."</td>";
										echo "<td>".$prev_price=format_change($row['price'])."</td>";
										echo "<td>".$prev_avg_price=format_change($row['AVG_PRICE'])."</td>";
									}
									else
									{
										$prev_qty=0;
										...
										echo "<td>".format_change($mom_qty)."</td>";
										echo "<td>".format_change($mom_price)."</td>";
										echo "<td>".format_change($mom_avg_price)."</td>";
										echo "</tr>";
																}
							}														
							?>
